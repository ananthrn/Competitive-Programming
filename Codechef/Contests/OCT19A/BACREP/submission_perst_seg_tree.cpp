...
void DfsComputePersistent(int src, int par, int n, int q, const vll & a, const vector<vi> &adj){
    ...
    for(int v: adj[src])
    {
        ...
        perstSegTree.revertToVersion(currentSrcVersion);
    }
...
// Problem Link: https://www.codechef.com/OCT19A/problems/BACREP
// Submission Link: https://www.codechef.com/ide
int main(void)
{
