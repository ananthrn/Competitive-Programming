...
int compute_test_case(int n, const vi & a){
    // vi dp(mx6+5,-1);
    // vi cnt(mx6+5,0);
    ...
    rep(j,0,n-1)
    {
        ...
        if(cnt[elem]>0)
        {
            int prev_ps = prev_pos[elem];
             ans = dp[elem];
            rep(k,prev_ps,j-1)
            {   
                // cout<<"j k a[k]: "<<j<<" "<<k<<" "<<a[k]<<endl;
                if(a[k]%a[j]==0)
                {   
                    ans+=1;
                }
        ...
        // cout<<"j: "<<j<<endl;
        // cout<<"elem: "<<elem<<endl;
        // cout<<"cnt[elem]: "<<cnt[elem]<<endl;
        // cout<<"prev_pos[elem]:"<<prev_pos[elem]<<endl;
        // cout<<"dp[elem]: "<<dp[elem]<<endl;
...
// Submission Link: https://www.codechef.com/viewsolution/27113680
int main(void)
{
